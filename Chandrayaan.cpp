// Chandrayaan Prototype Animation
// Developed by Vedika Prashant Chandratre
// © 2025 Vedika Prashant Chandratre
...
{
    setcolor(5);
    outtextxy(180,280,"Rain do not have the power to stop Our Chandrayaan-3!!!!");
    circle(x,380,20);
    line(x,400,x,430);
    line(x,415,x+10,410);
    line(x,430,x-10,460);
    line(x,430,x+10,460);
    setcolor(15);line(x+10,410,x+10,340);
    setcolor(4); line(x-25,340,x+50,340);
    setcolor(4);
...
void drawcloud(int x,int y)
{
    ...
    arc(x,y,135,225,r);
    arc(x+50,y,135+90,225+90,r);arc(x,y,135+90,225+90,r);
